    ...
    <div>
      ...
      <section id="About" className="container-fluid   page-section">
        ...
        <div className="entry-content">
          <h2>
            Top-rated Kerala tour operator Funday Holidays; travel agency in
            Kochi
          </h2>
          <p>
            Funday Holidays, a travel agency in Kochi, Kerala considered one of
            the leading <strong>Kerala travel agencies</strong> is your perfect
            travel partner. We are the top-rated tours and travels in Kochi,
            Kerala. With 12+ years of expertise in travel and tourism Funday
            Holidays have emerged as one among Kerala’s most reputable tour
            operator in Kochi. Our seasoned tourism professionals are focused on
            giving you the experience of a lifetime. Whether it is planning a
            family vacation, a solo journey, or a business trip, Funday Holidays
            understands your needs and opens up the best possibilities for you.
            This is why we are one of the leading tour and travel agencies in
            Kerala, India.
          </p>
          <p>
            Do you love to travel around the globe and experience the world? To
            get away from all the noise and stress of daily life and relax is
            everyone’s dream. The changes in outlook, broadening of horizons,
            and most importantly, the cherish-able memories formed are a few of
            the benefits of traveling.
          </p>
          <p>
            But it is not easy to make a good travel plan. Not everyone enjoys
            planning out days, and places to visit, and calculating the amount
            to spend. For many, it will take the fun out of the whole trip.
            However, if you have professional help, you will find the process
            much more enjoyable.
          </p>
          <p>
            We offer some of the best Kerala tour packages and international
            tour packages that take you to the most exciting experiences of the
            destination. As a <strong>leading Kerala tour operator</strong>, we
            make sure to unravel all the attractions in the land for you without
            lighting your wallet. Funday Holidays also allow you to customize
